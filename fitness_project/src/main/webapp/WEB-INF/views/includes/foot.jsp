<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/animsition.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/animsition-script.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/testimonial-carousel.js"></script>
